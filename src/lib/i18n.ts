...
const EN = {
  ...
  "feed.removedIntro": "You removed these by hand. Tap one to put it back.",
  ...
  "reader.hintTap": "Tap a line to translate it. Once it's open, tap a word to hear it and look it up.",
  ...
  "reader.askAi": "Ask AI about this",
  ...
  "sources.freeOnly": "Free & open only",
  "sources.hardPaywall": "Paywall",
  "sources.softPaywall": "Metered",
  "sources.blockedOnDevice": "Blocked on device",
  "sources.cleanShelf": "Clean shelf",
  "sources.cleanNow": "Remove flagged sources",
  "sources.unblock": "Unblock",
  "sources.freeBadge": "Open",
...
const DE: Record<StringKey, string> = {
  ...
  "feed.removedIntro": "Diese hast du selbst entfernt. Zum Zurückholen antippen.",
  ...
  "reader.hintTap": "Zeile antippen zum Übersetzen. Ist sie offen, Wort antippen zum Anhören und Nachschlagen.",
  ...
  "sources.freeOnly": "Nur frei zugänglich",
  "sources.hardPaywall": "Bezahlschranke",
  "sources.softPaywall": "Eingeschränkt",
  "sources.blockedOnDevice": "Geräte-Blockade",
  "sources.cleanShelf": "Regal bereinigen",
  "sources.cleanNow": "Markierte Quellen entfernen",
  "sources.unblock": "Freigeben",
  "sources.freeBadge": "Frei",
...
const VI: Record<StringKey, string> = {
  ...
  "feed.removedIntro": "Bạn đã tự xoá những bài này. Bấm vào để đưa lại.",
  ...
  "reader.hintTap": "Chạm vào một dòng để dịch. Khi đã mở, chạm vào một từ để nghe và tra nghĩa.",
  ...
  "reader.hideTranslation": "Ẩn bản dịch",
  "reader.original": "Mở bài gốc",
  "reader.copyLink": "Sao chép liên kết",
  "reader.linkCopied": "Đã sao chép",
  "reader.askAi": "Hỏi AI về bài này",
  ...
  "sources.freeOnly": "Chỉ nguồn mở & miễn phí",
  "sources.hardPaywall": "Tường phí",
  "sources.softPaywall": "Giới hạn đọc",
  "sources.blockedOnDevice": "Bị chặn tải",
  "sources.cleanShelf": "Dọn dẹp kệ báo",
  "sources.cleanNow": "Tự động lọc bỏ các nguồn này",
  "sources.unblock": "Bỏ chặn",
  "sources.freeBadge": "Mở",
